...
// @Override
// public Comentarios atualizarComentarios(Long id, Comentarios
// comentariosAtualizado) {
// Comentarios comentariosExiste =
// comentariosRepository.findById(id).orElse(null);
...
// } else {
// throw new RuntimeException("Comentarios " +
// comentariosAtualizado.getConteudo() + " Comentário não encontrado.");
